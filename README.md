![Simblast](https://user-images.githubusercontent.com/4358785/39079306-a5a409b6-44e5-11e8-8589-b4acd63b636e.jpg)
...
Simblast is an open source mass messaging tool on Android. It is currently available on the [Google Play Store](https://play.google.com/store/apps/details?id=com.simblast.app) and on [F-Droid](https://f-droid.org/repository/browse/?fdid=com.simblast.app)
...
Simblast is developed and maintained by [Moez Bhatti](https://github.com/moezbhatti). Feel free to reach out to moez@qklabs.com

## License

Simblast is released under the **The GNU General Public License v3.0 (GPLv3)**, which can be found in the `LICENSE` file in the root of this project.
