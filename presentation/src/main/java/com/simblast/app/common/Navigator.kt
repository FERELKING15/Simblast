...
class Navigator @Inject constructor(
    ...
    fun showMassSend() {
        val intent = Intent(context, com.simblast.app.feature.masssend.MassSendActivity::class.java)
        startActivity(intent)
    }
    ...
    fun showRating() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.simblast.app"))
        ...
        try {
            ...
            val url = "http://play.google.com/store/apps/details?id=com.simblast.app"
