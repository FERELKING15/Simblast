 ...
 */
package com.simblast.app.feature.main
...
import com.simblast.app.common.androidxcompat.drawerOpen
import com.simblast.app.common.base.QkThemedActivity
import com.simblast.app.common.util.extensions.autoScrollToStart
import com.simblast.app.common.util.extensions.dismissKeyboard
import com.simblast.app.common.util.extensions.resolveThemeColor
import com.simblast.app.common.util.extensions.scrapViews
import com.simblast.app.common.util.extensions.setBackgroundTint
import com.simblast.app.common.util.extensions.setTint
import com.simblast.app.common.util.extensions.setVisible
import com.simblast.app.feature.blocking.BlockingDialog
import com.simblast.app.feature.changelog.ChangelogDialog
import com.simblast.app.feature.conversations.ConversationItemTouchCallback
import com.simblast.app.feature.conversations.ConversationsAdapter
...
class MainActivity : QkThemedActivity(), MainView {
    ...
    // FAB clicks are handled manually to provide a small menu
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // intercept compose button click and show a small menu
    ...
    private fun showComposeMenu() {
        val popup = android.widget.PopupMenu(this, compose)
        popup.menu.add(Menu.NONE, Menu.FIRST, Menu.NONE, R.string.menu_new_conversation)
        popup.menu.add(Menu.NONE, Menu.FIRST + 1, Menu.NONE, R.string.menu_mass_send)
        popup.setOnMenuItemClickListener { item ->
            when (item.itemId) {
                Menu.FIRST -> navigator.showCompose()
                Menu.FIRST + 1 -> navigator.showMassSend()
            }
            true
        }
        popup.show()
